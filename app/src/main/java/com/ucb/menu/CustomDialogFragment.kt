...
class CustomDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        titleTextView.text = "Dragon"
        messageTextView.text = "You find yourself standing before a majestic dragon, its scales shimmering like precious gems in the light. The air crackles with tension as it regards you with ancient, wise eyes. Will you attempt to communicate with the dragon, or will you draw your weapon?"
